...
def create_icosahedral_capsid_graph(faceEdges:List[Edge],triangleVertices:Tuple[Point,Point,Point],bondStrength:List[float] | None=None)->nx.Graph:
	...
	for face_id in range(20):
		face,face_coordinates = create_face_graph(faceEdges,face_id,node_id,bondStrength=bondStrength)
