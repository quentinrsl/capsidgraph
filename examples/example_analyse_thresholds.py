...
fragmentation_weighted_threshold_nodes = get_fragmentation_strength_threshold_node(G, error_prob, steps, max_iterations=max_iterations, process_number=process_number, debug=True)
...
print("Fragmentation strength threshold (weighted) for nodes: ", fragmentation_weighted_threshold_nodes)
